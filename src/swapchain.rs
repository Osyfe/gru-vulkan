...
impl Device
{
    pub fn new_swapchain(&self, old_swapchain: Option<Swapchain>, (width, height): (u32, u32), v_sync: bool) -> Swapchain
    {
        ...
        let surface_loader = &self.0.instance.surface_loader;
        let surface = &self.0.instance.surface;
        ...
        let swapchain_image_views = unsafe { swapchain_loader.get_swapchain_images(swapchain) }.unwrap().iter().map(|image|
        {
        ...
        Swapchain
        {
            ...
            count,
            cycle_index: std::cell::Cell::new(0)
        }
    }
}
...
impl Swapchain
{
    ...
    pub fn acquire_next_image(&self, signal: Option<&Semaphore>, mark: Option<&Fence>) -> Result<SwapchainObjectIndex, ()>
    {
        ...
        match unsafe
        {
            self.swapchain_loader.acquire_next_image(self.swapchain, std::u64::MAX, semaphore, fence)
        }
        {
    ...
    pub fn get_image(&self, index: &SwapchainObjectIndex) -> SwapchainImage
    {
        SwapchainImage
        {
